...
class GradeController:
    ...
    def __init__(self, repo, gradeValidator, studentController, assignmentController, undoController):
        '''
            Creats a repo, gradeValidator, studentController, assignmentController, undoController
        '''
        self._repo = repo
